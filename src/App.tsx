...
const MainLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen min-h-[100dvh] w-full bg-stone-100 text-stone-900 font-sans overflow-x-hidden md:overflow-hidden relative">
      {/* Sidebar Navigation */}
      <Sidebar
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col min-w-0 md:overflow-hidden min-h-0">
        <Navbar
        ...
        />
        <main className="flex-1 flex flex-col min-h-0 md:overflow-hidden overflow-y-auto touch-scroll">
          {renderCurrentView()}
        </main>
      </div>
    </div>
